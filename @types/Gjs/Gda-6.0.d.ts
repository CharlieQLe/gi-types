...
import type libxml2 from './libxml2-2.0.js';
...
interface MetaColumn {
    ...
    readonly column_type_name: string
    name: string
...
interface Query {
    ...
    cancel(_callback_: Gio.AsyncReadyCallback<this> | null, _user_data_: object | null): void
    cancel_finish(_res_: Gio.AsyncResult): void
    execute(_callback_: Gio.AsyncReadyCallback<this> | null, _user_data_: object | null): void
    get_name(): string
    get_sql(): string

    // Own virtual methods of Gda-6.0.Gda.Query

    vfunc_cancel(_callback_: Gio.AsyncReadyCallback<this> | null, _user_data_: object | null): void
    vfunc_cancel_finish(_res_: Gio.AsyncResult): void
    vfunc_execute(_callback_: Gio.AsyncReadyCallback<this> | null, _user_data_: object | null): void
    vfunc_get_name(): string
...
interface QueryIface {
    ...
    execute: (self: Query, _callback_: Gio.AsyncReadyCallback | null, _user_data_: object | null) => void
    cancel: (self: Query, _callback_: Gio.AsyncReadyCallback | null, _user_data_: object | null) => void

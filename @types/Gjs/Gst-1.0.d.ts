...
module Bin {
     ...
     */
    interface DeepElementAddedSignalCallback {
     ...
     */
    interface DeepElementRemovedSignalCallback {
        ($obj: Bin, sub_bin: Bin, element: Element): void
    }
...
interface Bin extends ChildProxy {
    ...
    connect_after(sigName: "deep-element-added", callback: Bin.DeepElementAddedSignalCallback): number
    ...
    connect_after(sigName: "deep-element-removed", callback: Bin.DeepElementRemovedSignalCallback): number
...
module Clock {
     ...
     */
    interface SyncedSignalCallback {
...
interface Clock {
    ...
    connect_after(sigName: "synced", callback: Clock.SyncedSignalCallback): number
...
interface ControlSource {
     ...
     */
    parent: Object
    // Has conflict: get_value: ControlSourceGetValue
    /**
...
interface Device {
    ...
    connect_after(sigName: "removed", callback: Device.RemovedSignalCallback): number
...
module DeviceProvider {
     ...
     */
    interface ProviderHiddenSignalCallback {
     ...
     */
    interface ProviderUnhiddenSignalCallback {
        ($obj: DeviceProvider, object: string): void
    }
...
interface DeviceProvider {
    ...
    connect_after(sigName: "provider-hidden", callback: DeviceProvider.ProviderHiddenSignalCallback): number
    ...
    connect_after(sigName: "provider-unhidden", callback: DeviceProvider.ProviderUnhiddenSignalCallback): number
...
class Element extends Object {
     ...
     * @param value the value to set
     */
    static add_metadata(klass: Element | Function | GObject.GType, key: string, value: string): void
    /**
     ...
     */
    static add_pad_template(klass: Element | Function | GObject.GType, templ: PadTemplate): void
    /**
     * Set `key` with `value` as metadata in `klass`.
     * 
     ...
     * @param value the value to set
     */
    static add_static_metadata(klass: Element | Function | GObject.GType, key: string, value: string): void
    /**
     ...
     */
    static add_static_pad_template(klass: Element | Function | GObject.GType, static_templ: StaticPadTemplate): void
    /**
     * Adds a pad template to an element class based on the static pad template
     * `templ`. This is mainly used in the _class_init functions of element
     * implementations. If a pad template with the same name already exists,
     ...
     */
    static add_static_pad_template_with_gtype(klass: Element | Function | GObject.GType, static_templ: StaticPadTemplate, pad_type: GObject.GType): void
    /**
     * Get metadata with `key` in `klass`.
     * @param key the key to get
     */
    static get_metadata(klass: Element | Function | GObject.GType, key: string): string
    /**
     ...
     * @param name the name of the #GstPadTemplate to get.
     */
    static get_pad_template(element_class: Element | Function | GObject.GType, name: string): PadTemplate | null
    /**
     ...
     * > #GInstanceInitFunc here.
     */
    static get_pad_template_list(element_class: Element | Function | GObject.GType): PadTemplate[]
    /**
     ...
     * @param author Name and contact details of the author(s). Use \n to separate multiple author metadata. E.g: "Joe Bloggs &lt;joe.blogs at foo.com&gt;"
     */
    static set_metadata(klass: Element | Function | GObject.GType, longname: string, classification: string, description: string, author: string): void
    /**
     * Sets the detailed information for a #GstElementClass.
     * 
     * > This function is for use in _class_init functions only.
     ...
     * @param author Name and contact details of the author(s). Use \n to separate multiple author metadata. E.g: "Joe Bloggs &lt;joe.blogs at foo.com&gt;"
     */
    static set_static_metadata(klass: Element | Function | GObject.GType, longname: string, classification: string, description: string, author: string): void
}
...
module SharedTaskPool {
    ...
    interface ConstructorProperties extends TaskPool.ConstructorProperties {
    }
...
module StreamCollection {
     ...
     */
    interface StreamNotifySignalCallback {
...
interface StreamCollection {
    ...
    connect_after(sigName: "stream-notify", callback: StreamCollection.StreamNotifySignalCallback): number
...
abstract class ElementClass {
    ...
    // Owm static methods of Gst-1.0.Gst.ElementClass
...
class Event {
     ...
     * @constructor 
     * @param structure description of the event. The event will take     ownership of the structure.
     */

...
module Indicator {
    ...
    interface NewIconThemePathSignalCallback {
        ($obj: Indicator, object: string): void
    }
    ...
    interface NewLabelSignalCallback {
        ($obj: Indicator, object: string, p0: string): void
    }
    ...
    interface NewStatusSignalCallback {
        ($obj: Indicator, arg1: string): void
    }
...
interface Indicator {
    ...
    emit(sigName: "new-icon-theme-path", object: string, ...args: any[]): void
    ...
    emit(sigName: "new-label", object: string, p0: string, ...args: any[]): void
    ...
    emit(sigName: "new-status", arg1: string, ...args: any[]): void

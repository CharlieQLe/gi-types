...
interface MultipartInputStream extends Gio.PollableInputStream {
     ...
     * @param cancellable a #GCancellable.
     */
    next_part_async(io_priority: number, cancellable: Gio.Cancellable | null): Promise<Gio.InputStream>
    /**
     * Obtains a [class`Gio`.InputStream] for the next request.
     * 
     * See [method`MultipartInputStream`.next_part] for details on the workflow.
...
interface Session {
     ...
     * @param cancellable a #GCancellable
     */
    websocket_connect_async(msg: Message, origin: string | null, protocols: string[] | null, io_priority: number, cancellable: Gio.Cancellable | null): Promise<Soup.WebsocketConnection>
    /**
     * Asynchronously creates a [class`WebsocketConnection]` to communicate with a
     * remote server.
     * 

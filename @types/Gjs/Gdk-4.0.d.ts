...
interface Clipboard {
     ...
     * @param cancellable optional `GCancellable` object
     */
    read_async(mime_types: string[], io_priority: number, cancellable: Gio.Cancellable | null): Promise<Gio.InputStream>
    /**
     * Asynchronously requests an input stream to read the `clipboard'`s
     * contents from.
     * 
     ...
     * @param cancellable optional `GCancellable` object
     */
    read_text_async(cancellable: Gio.Cancellable | null): Promise<string>
    /**
     * Asynchronously request the `clipboard` contents converted to a string.
     * 
     * When the operation is finished `callback` will be called. You must then
     ...
     */
    read_texture_async(cancellable: Gio.Cancellable | null): Promise<Gdk.Texture>
    /**
     * Asynchronously request the `clipboard` contents converted to a `GdkPixbuf`.
     * 
     * When the operation is finished `callback` will be called. You must then
     ...
     * @param cancellable optional `GCancellable` object
     */
    read_value_async(type: GObject.GType, io_priority: number, cancellable: Gio.Cancellable | null): Promise<any>
    /**
     * Asynchronously request the `clipboard` contents converted to the given
     * `type`.
     * 
...
interface ContentProvider {
     ...
     * @param cancellable optional `GCancellable` object, %NULL to ignore.
     */
    write_mime_type_async(mime_type: string, stream: Gio.OutputStream, io_priority: number, cancellable: Gio.Cancellable | null): Promise<boolean>
    /**
     * Asynchronously writes the contents of `provider` to `stream` in the given
     * `mime_type`.
     * 
     ...
     * @param cancellable optional `GCancellable` object, %NULL to ignore.
     */
    vfunc_write_mime_type_async(mime_type: string, stream: Gio.OutputStream, io_priority: number, cancellable: Gio.Cancellable | null): Promise<boolean>
    /**
     * Asynchronously writes the contents of `provider` to `stream` in the given
     * `mime_type`.
     * 

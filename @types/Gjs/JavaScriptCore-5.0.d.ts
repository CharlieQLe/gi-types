...
interface Value {
     ...
     */
    array_buffer_get_data(size: number | null): object | null
    /**
     ...
     */
    typed_array_get_data(): [ /* returnType */ object | null, /* length */ number | null ]
    /**
...
class Value extends GObject.Object {
     ...
     */
    static new_array_buffer(context: Context, data: object | null, size: number, destroy_notify: GLib.DestroyNotify | null, user_data: object | null): Value
    /**
